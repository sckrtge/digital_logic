...
(* CORE_GENERATION_INFO = "mux4x3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mux4x3,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mux4x3.hwdef" *) 
module mux4x3
   (led,
    s0,
    s1,
  ...
  assign s0_1 = s0[2:0];
  assign s14_1 = s14[2:0];
  assign s15_1 = s15[2:0];
  assign s1_1 = s1[2:0];
  assign s2_1 = s2[2:0];
  assign s3_1 = s3[2:0];
