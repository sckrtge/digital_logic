...
HD_PWD='C:/Users/Gxm/Documents/code/digital_logic/experiment_1/experiment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x3_verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4x3_verilog.tcl -notrace
